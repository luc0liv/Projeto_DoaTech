 ...
 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapseNavbar"><span class="navbar-toggler-icon"></span></button>
    ...
    <div class="collapse navbar-collapse" id="collapseNavbar">
        <ul class="nav nav-fill">
             <a class="navbar-brand" href="index.php"><img src="./assets/img/doatech.png" width="150px" alt="Logo Full Stack Eletro"></a>
            <li class="nav-item "> 
                <a class="nav-link active text-primary" href="index.php">Página Inicial</a> 
            </li>
            <li class="nav-item">
                <a class="nav-link active text-primary" href="comofunciona.php">Como funciona</a>
            </li>
            <li class="nav-item">
